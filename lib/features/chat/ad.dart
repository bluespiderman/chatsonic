...
class GFAccordionAd extends StatefulWidget {
  ...
  /// content of type[String] which shows the messages after the [GFAccordionAd] is expanded
  final String? content;

  /// contentChild of  type [Widget]is alternative to content key. content will get priority over contentChild
  final Widget? contentChild;

  /// type of [Color] or [GFColors] which is used to change the background color of the [GFAccordionAd] title when it is collapsed
  final Color collapsedTitleBackgroundColor;

  /// type of [Color] or [GFColors] which is used to change the background color of the [GFAccordionAd] title when it is expanded
  final Color expandedTitleBackgroundColor;

  /// collapsedIcon of type [Widget] which is used to show when the [GFAccordionAd] is collapsed
  final Widget collapsedIcon;

  /// expandedIcon of type[Widget] which is used when the [GFAccordionAd] is expanded
  ...
  /// titlePadding of type [EdgeInsets] which is used to set the padding of the [GFAccordionAd] title
  final EdgeInsets titlePadding;

  /// descriptionPadding of type [EdgeInsets] which is used to set the padding of the [GFAccordionAd] description
  final EdgeInsets contentPadding;

  /// type of [Color] or [GFColors] which is used to change the background color of the [GFAccordionAd] description
  final Color? contentBackgroundColor;

  /// margin of type [EdgeInsets] which is used to set the margin of the [GFAccordionAd]
  ...
  @override
  _GFAccordionAdState createState() => _GFAccordionAdState();
}

class _GFAccordionAdState extends State<GFAccordionAd>
                ...
                child: showAccordion
                    ? Container(
                        decoration: BoxDecoration(
                          ...
                          color:
                              widget.contentBackgroundColor ?? Colors.white70,
                        ),
